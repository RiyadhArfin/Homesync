          ...
          <div className="privacy-card">
            ...
            <div className="policy-section">
              ...
              <div className="contact-details-box">
                <strong>Homesync LLC</strong><br />
                Richmond, VA<br />
                Email: <a href="mailto:info@homesyncllc.org">info@homesyncllc.org</a><br />
                Phone: <a href="tel:8042922009">(804) 292-2009</a>
              </div>
            </div>
            ...
            <div className="policy-footer">
              ...
              <p>
                Homesync LLC reserves the right to modify this Privacy Policy at any time, and such modifications shall be effective immediately upon posting of the modified Privacy Policy on the Site. Your continued use of the Site after any such modifications constitutes your acceptance of the revised Privacy Policy.
              </p>
              <p className="effective-date">Effective Date: June 21st, 2023</p>
            </div>
          </div>
        </div>
      </section>
